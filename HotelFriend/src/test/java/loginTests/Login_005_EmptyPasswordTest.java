 ...
 */
public class Login_005_EmptyPasswordTest extends BaseTest{@Test
public void test_005() {
    ...
    assertEquals(getElementText(gmailLoginPage.passwordError, "Empty Password Error"),
            error.get("errorEmptyPassword"), "Password Incorrect Error message");
